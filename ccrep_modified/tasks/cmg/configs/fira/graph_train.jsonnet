...
local pretrained_model = "microsoft/graphcodebert-base";
...
local max_lines = 32;
local target_vocab_size = 50265 + std.length(additional_special_tokens);
...
//          max_length: code_max_tokens
    ...
    fusion: {
      ...
      reproject_before_merge: true,
      reproject_dropout: 0.3,
      hybrid_merge_method: 'add',
