...
class ImpCcMsgSeqinClassifier(Model):
    ...
    def forward_features(self,
        ...
        """
        add_code_feature = self._encode_text_field(
            diff_add, self._code_embedder, self._code_encoder)
        del_code_feature = self._encode_text_field(
            diff_del, self._code_embedder, self._code_encoder)
        ...
        if msg is not None:
            msg_feature = self._encode_text_field(
                msg, self._msg_embedder, self._msg_encoder)
    ...
    def _encode_text_field(self, tokens: Dict[str, Dict[str, torch.Tensor]],
        ...
        embedded_features = embedder(
            tokens, num_wrapping_dims=num_wrapping_dim)
