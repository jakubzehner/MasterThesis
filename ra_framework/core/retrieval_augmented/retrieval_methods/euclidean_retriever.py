...
class EuclideanRetriever(RetrieverBase):
    def __init__(self, batch_size: int = 16):
        super().__init__(retrieval_method_name="euclidean", largest=False)
    ...
    def retrieve(
        ...
        """
        Retrieve the top-k items from the database based on Euclidean distance with the query.
        Args:
        ...
        for start in range(0, real_batch_size, self.batch_size):
            ...
            distances = torch.norm(query_expanded - db_expanded, p=2, dim=2)
